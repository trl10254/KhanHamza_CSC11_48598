...
void problem2()
{
    ...
    cout << "Bill Creator" << endl;
    
    cout << "Please chose your package [a/b/c]:  ";
    cin >> r1;
...
void problem3()
{
    ...
    cout<<"The result of the term is:  " <<r0;
}
